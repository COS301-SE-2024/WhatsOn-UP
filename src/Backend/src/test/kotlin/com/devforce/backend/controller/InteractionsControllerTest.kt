...
@Transactional
class InteractionsControllerIntegrationTest {
    ...
    private final val baseUri = "http://localhost:8080/api/interactions"
    ...
    fun `test get all users`(){
        val response = mockMvc.perform(get("$baseUri/get_all_users")
