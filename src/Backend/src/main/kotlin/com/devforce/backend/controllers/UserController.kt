...
class UserController {
    ...
    fun registerUser(@RequestBody userData: Map<String, String>): ResponseEntity<Any> {
        ...
        return try {
            ...
            ResponseEntity.badRequest().body(ApiResponse("error", System.currentTimeMillis(), "An error occurred while registering user"))
        }
    }
    ...
    fun loginUser(@RequestBody userData: Map<String, String>): ResponseEntity<Any> {
        ...
        return try {
            ...
            if (user != null) {
                ...
                ResponseEntity.badRequest().body(ApiResponse("error", System.currentTimeMillis(),"Invalid email or password"))
            }
        } catch (e: Exception) {
            ResponseEntity.badRequest().body(ApiResponse("error", System.currentTimeMillis(), "An error occurred while logging in user"))
        }
    }
